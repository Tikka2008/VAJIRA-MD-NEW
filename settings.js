...
global.owner = process.env.OWNER_NUMBER  || '94761180276' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=SAcXyIyD#PHogvXE_bq4bzYrFGNc5mxSlTwwyv1ZMQrw1SEMFqsQ' ,
